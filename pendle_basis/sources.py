                    ...
                    for it in items:
                        ...
                        out.append(
                            MarketSnapshot(
                                ...
                                underlying_apy=_to_float(it.get("underlyingApy") or it.get("assetApy") or it.get("baseApy")),
                                pt_price=_to_float(it.get("ptPrice") or it.get("pt")),
                                yt_price=_to_float(it.get("ytPrice") or it.get("yt")),
                                maturity_days=_to_float(it.get("maturityDays") or it.get("daysToMaturity")),
